...
//     <Router>
//       <div
//         className={`min-h-screen text-gray-800 flex flex-col animate-fade-in ${
...
// //         // In a real app, call an API to send reset email
// //         return { ok: true };
// //       }
// //     } catch (err) {
// //       console.error("Auth error:", err);
...
// //       <div
// //         className={`min-h-screen text-gray-800 flex flex-col animate-fade-in ${
// //           darkMode ? "dark bg-gray-900 text-white" : "bg-primary-1"
// //         }`}
// //       >
// //         <Header
// //           loggedIn={loggedIn}
...
// // //       <div
// // //         className={`min-h-screen text-gray-800 flex flex-col ${
// // //           darkMode ? "dark bg-gray-900 text-white" : "bg-eco-light"
// // //         }`}
// // //       >
// // //         <Header
// // //           loggedIn={loggedIn}
...
// // //           text="🤖"
// // //           onClick={toggleModal}
// // //           className={`fixed bottom-4 right-4 z-50 w-12 h-12 rounded-full bg-primary-3 text-white shadow-lg flex items-center justify-center text-2xl hover:bg-primary-2 ${
// // //             isAnimating ? "animate-spin-light" : ""
// // //           }`}
// // //         />
// // //         <ChatbotModal
